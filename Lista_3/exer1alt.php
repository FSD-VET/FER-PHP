...
<html lang="en">
  <head>
    ...
    <title>Exercício 1 Alternativo - Menor Valor e sua Posição</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  </head>
  <body>

 
    <h1><center>Exercício 1 Alternativo - Menor Valor e sua Posição<center></h1><br>



    
    <h1><center>Digite 7 números diferentes<center></h1><br><br>

    
    <form method="post" action = "exer1altresposta.php">
